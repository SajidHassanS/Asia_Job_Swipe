...
const SignInPage = () => {
              ...
              <Card className="border-none shadow-none">
                ...
                <CardContent className="space-y-5">
                  ...
                  {auth.errors.length > 0 && (
                    <div className="mt-4">
                      {auth.errors
                        .filter((error: { path: string; message: string }) => error.path === "unknown")
                        .map((error: { path: string; message: string }, index: number) => (
  ...
  {roleError && (
    <p className="text-center mt-4 text-red-500">{roleError}</p>
  )}
</CardDescription>
