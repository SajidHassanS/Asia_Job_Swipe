      ...
      <DialogContent className="overflow-auto max-h-[80vh] p-5">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <DropdownMenu open={isSkillsDropdownOpen} onOpenChange={setIsSkillsDropdownOpen}>
                    ...
                    {skills.length > 0 ? (
                      skills.map((skill) => (
                        <DropdownMenuCheckboxItem
                          ...
                          onCheckedChange={(checked) => handleMultiSelectChange({ target: { value: skill.name, checked } } as React.ChangeEvent<HTMLInputElement>, 'skillsRequired')}
                        >
                          {skill.name}
                        </DropdownMenuCheckboxItem>
                      ))
                ...
                {formData.skillsRequired.map((skill) => (
                  ...
                  >
                    ...
                    <RiCloseLine
                      ...
                      size={16}
                      onClick={() => handleMultiSelectChange({ target: { value: skill, checked: false } } as React.ChangeEvent<HTMLInputElement>, 'skillsRequired')}
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="mb-8">
              ...
              >
                <option value="">Select</option>
                {City.getCitiesOfState(formData.country, formData.province).map((city) => (
          ...
          <div className="mb-8">
            ...
            <div className="relative">
              <DropdownMenu open={isBenefitsDropdownOpen} onOpenChange={setIsBenefitsDropdownOpen}>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
